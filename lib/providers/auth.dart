...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyCdHak3ra5dUJjnauDo-XupNhIBCBOkRSA';
  ...
  Future<void> sigin(String email, String senha) async {
